...
If you prefer to use it directly from the Github repository, you can also use the `cpanfile` included in the
repository by using the cpanm (App::cpanminus) with `--installdeps` option.
